...
class HomeViewController<T: HomeView, J: HomeViewModel>: BaseViewController<T, J>, UITableViewDelegate, UITableViewDataSource {
    ...
    override func addViewModelListeners() {
    ...
    override func removeUIListeners() {
    ...
    override func removeViewModelListeners() {
