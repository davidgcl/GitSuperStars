...
public extension UIViewController {
    ...
    func extShowAlert(title: String, message: String, completion: ((_ success: Bool) -> Void)? ) {
        ...
        // customize ok action
        let okLocalizedAttributtedText = NSMutableAttributedString(string: LocalizedString.confirm.value.uppercased())
        ...
        okLocalizedAttributtedText.addAttribute(NSAttributedString.Key.font, value: Font.robotoMedium.value(size: Size.fontSubtitle.value), range: okRange)
        ...
        attributedTitleText.addAttribute(NSAttributedString.Key.font, value: Font.robotoMedium.value(size: Size.fontSubtitle.value), range: titleRange)
        ...
        attributedMessageText.addAttribute(NSAttributedString.Key.font, value: Font.robotoRegular.value(size: Size.fontBody.value), range: messageRange)
